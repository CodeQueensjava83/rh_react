          ...
          <div className=' flex flex-col rounded-3xl overflow-hidden justify-between'>
            ...
            <div className="flex">
                <Link to={`/editardepartamento/${departamentos.id}`} 
                    className='w-full text-black bg-amber-300 
                    hover:bg-amber-200 flex items-center justify-center py-2'>
                    <button>Editar</button>
                </Link>
                <Link to={`/deletardepartamento/${departamentos.id}`} 
                    className='text-black bg-amber-500 
                    hover:bg-amber-400 w-full flex items-center justify-center'>
