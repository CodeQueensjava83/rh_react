...
import { listar, atualizar } from "../../services/Service"
...
function AtualizarPerfil() {
	...
	async function listarUsuarioPorId() {
		try {
			...
			<div className="container mx-auto max-w-7xl">
				<div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
					<div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr]">
						{/* Seção da foto */}
						<div className="bg-linear-to-br from-orange-500 via-orange-400 to-orange-300 p-8 flex flex-col items-center justify-center">
						...
						<div className="p-8 lg:p-12">
							...
							<form onSubmit={atualizarUsuario} className="space-y-6">
								...
								<div className="flex flex-col sm:flex-row gap-4 pt-4">
									...
									<button
										type="submit"
										className="flex-1 px-6 py-3 bg-orange-600 text-white font-semibold rounded-xl hover:from-orange-700 hover:to-orange-800 shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
										disabled={isLoading}
									>
										{isLoading ? (
